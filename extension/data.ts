...
export interface VSCodeHTMLCustomData {
  $id: string;
  ...
  /**
   * A set of attribute value. When an attribute refers to an attribute set,
   * its value completion will use value from that set
   */
  valueSets?: ValueSet[];
}

export const data: VSCodeHTMLCustomData = {
  ...
  valueSets: [
    {
      ...
      values: [
        {
          name: 'true',
          description: 'A boolean value of `true`'
        },
        {
          name: 'false',
          description: 'A boolean value of `false`. This is the **default** value SPX applies when the `state` reference of `static define = {}` passes the `Boolean` constructor.'
        }
      ]
    }
  ]
